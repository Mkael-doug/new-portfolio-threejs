    ...
    return (
        <>
            <div className="items-start mt-25 md:mt-35 c-space">
                ...
                <h3 className="text-subheader text-center md:text-end text-neutral-500 font-extralight italic">&mdash; Depoimentos ilustrativos para demonstração de layout.</h3>
            </div>
        </>
    )
}
